      ...
      try{
        if(Platform.isIOS){
          await Firebase.initializeApp(
            name: 'Viprofood',
            options: FirebaseOptions(apiKey: 'AIzaSyAcucKfH2ISqHIQEbG_Rp5RgUpSfc2iuGY', appId: '1:1086781393261:ios:aef4255493eae832de7264', messagingSenderId: '1086781393261', projectId: 'viprofood'),
          );
                                                ...
                                                child: (showProgress)
                                                  ...
                                                  onPressed: () {
                                                    if (!showProgress) {
                                                      ...
                                                      int indexN = phoneNumberController.text.indexOf('0');
                                                      if(indexN==0){
                                                        if (phoneNumberController.text != null &&
                                                            phoneNumberController.text.replaceFirst('0', '').length.clamp(10, 12)>=10) {
                                                          hitLoginUrl('${phoneNumberController.text.replaceFirst('0', '')}', '', 'otp',
                                                              context);
                                                        } else {
                                                        ...
                                                        if (phoneNumberController.text != null &&
                                                            phoneNumberController.text.length.clamp(10, 12)>=10) {
