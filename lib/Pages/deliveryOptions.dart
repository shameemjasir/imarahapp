...
class DeliveryOptionState extends State<DeliveryOption> {
  ...
  void getAddressByUserId(dynamic storeid, AppLocalizations locale) async {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    if (!enterFirst) {
      ...
      getAddressByUserId(store_id,locale);
      hitDateCounter(date);
    }
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: isFetchingTime
                                  ...
                                  : (radioList!=null && radioList.length>0)?ListView.builder(
                                      primary: false,
                                      scrollDirection: Axis.vertical,
                                      shrinkWrap: true,
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    '${radioList[index].availibility}' ==
                                                        ...
                                                        ? Row(
                                                            children: [
                                                              Text(double.parse('${deliveryFee}')>0.0?'$apcurrency $deliveryFee':locale.do8,
                                                                  textAlign:
                                                                      TextAlign
                                                                          .left,
                                                                  style: TextStyle(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(locale.noTimeSlotText),
                                ),
                              )),
                          Visibility(
                            visible: isOpenMenu,
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text('$apcurrency ${totalMrp.toStringAsFixed(2)}',
                                                        style: TextStyle(
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text('$apcurrency ${totalPrice.toStringAsFixed(2)}',
                                                        style: TextStyle(
                                                            fontWeight: FontWeight.normal,
                                                            color: kMainTextColor,
                                                            fontSize: 15)),
  ...
  void makeOrderRequest(AppLocalizations locale) async {
    ...
    http.post(makeOrderUri, body: {
      ...
      'time_slot': '${radioList[idd1].timeslot}',
    }, headers: {
      'Authorization': 'Bearer ${prefs.getString('accesstoken')}'
    }).then((value) {
