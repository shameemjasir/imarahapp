...
var http = Client();
  ...
  Widget build(BuildContext context) {
    ...
    print(orderData.price);
    print(orderData.remainingAmount);
    print(orderData.delCharge);
    print(orderData.timeSlot);
    print(double.parse('${orderData.delCharge}'));
    print(double.parse('${orderData.price}'));
    print(double.parse('${orderData.price}')-double.parse('${orderData.delCharge}'));
    print((11.87-5.99).roundToDouble());
                ...
                children:[
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text("${locale.orderID.toUpperCase()} - #${orderData.cartId}",
                        ...
                        Expanded(
                          child: Text('${orderData.deliveryDate}\n${orderData.timeSlot}',
                          ...
                          child: Column(
                            children: [
                              buildAmountRow(locale.subtotal,
                                  '$apcurrency ${orderData.sub_total}'),
