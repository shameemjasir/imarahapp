...
import 'package:grocery/providergrocery/benprovider/appnoticebean.dart';
...
class NewHomeView1State extends State<NewHomeView1> {
  ...
  void _onRefresh() async {
    print('onrefresh');
    singleApiEmitter.hitSingleApiEmitter('${widget.locModel.storeFinderData.store_id}', _refreshController);
...
// void getStoreId() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    if (apiData != null && apiData.dataModel.status == '1') {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            (tabList != null && tabList.length > 0)
                                ? BlocBuilder<TopRecentNewDealProvider, TopRecentNewDataBean>(
                      ...
                      return Container(
                        ...
                        child: Text((apiData.dataModel != null &&
                            ...
                            : locale.aa5,textAlign: TextAlign.center,),
                      );
                    }
                  }
                },
      ...
      BlocBuilder<ProfileProvider, AppInfoModel>(
              ...
              return SpeedDial(
                  ...
                  children: [
                    ...
                    SpeedDialChild(
                      ...
                      backgroundColor: kMainColor,
                      onTap: () {
                        callNumberStore(widget.locModel.storeFinderData.store_number);
                      },
                    ),
                    SpeedDialChild(
                      child: ImageIcon(
  ...
  Future<void> share(String share, String sharetext, AppInfoModel modelApp) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var applink =
