      ...
      if (value.statusCode == 200) {
        ...
        if (data1!=null && '${data1.status}' == '1') {
          setState(() {
            ...
            prefs.setString('numberlimit', '${int.parse('${data1.phoneNumberLength}')}');
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(isCouponAppliedProgress?locale.po2:locale.po3,textAlign: TextAlign.center,style: TextStyle(
                    ...
                    onTap: (){
                      if(!isLoading){
                        ...
                        if(walletAmount>=checkoutAmout){
                          ...
                          Toast.show(locale.paymentmethod1, context,duration: Toast.LENGTH_SHORT,gravity: Toast.CENTER);
                        }
                      }
                    },
                    behavior: HitTestBehavior.opaque,
                      ...
                      color: kMainColor,
                        ...
                        Expanded(
                          ...
                          children: [
                            ...
                            Visibility(
                              visible: double.parse('${makeOrderData.rem_price}')>walletAmount,
                              child: Text(
                                  "${locale.po5} $apCurrency ${getRestWalletAmount()} ${locale.po6}",
                                  style: TextStyle(
                                      fontWeight: FontWeight.normal,
                                      color: Colors.pink,
                                      fontSize: 15)),
                        ...
                        child: buildPaymentType(
                          ...
                          if(!isLoading){
                            ...
                            Navigator.of(context).push(MaterialPageRoute(builder: (context){
                              // return PaypalPayment(apCurrency:'USD',clientId:'AU5k7BFuFYBD3KH0_zJO8qwHcqeTWVi1qGCQtf6F2NmNEB2W2eASLBuxalCMQpwAGHzlOQIjd3yNWp6_',secret:'EFzc9P54xZUrilzaHlzkcjMo4vYcHko3kY6ykFvdIcWjGjwKgll8JQRsNGERuGRXyqMOt2hmXoHsno-m',amount: '${double.parse('${makeOrderData.rem_price}')}',onFinish:(id,status){
                              //   print('$id $status');
                              //   if(status=='success'){
                              ...
                              //   }
                              // });
                              return PaypalPayment(apCurrency:paymentCurrency,clientId:'${payPalBean.paypal_client_id}',secret:'${payPalBean.paypal_secret}',amount: '${double.parse('${makeOrderData.rem_price}')}',onFinish:(id,status){
                                // print('$id $status');
                                if(status=='success'){
                                  checkOut('Card', 'success', 'no', '$id', 'paypal');
                                }else{
                          ...
                          if(!isLoading){
                            ...
                            Navigator.of(context).pushNamed(PageRoutes.stripecard).then((value){
                              if(value!=null){
                                ...
                                setStripePayment(stripeBean.stripe_secret,double.parse('${makeOrderData.rem_price}'),cardPay,paymentCurrency,context);
                              }else{
                                Toast.show(locale.po10, context,gravity: Toast.CENTER,duration: Toast.LENGTH_SHORT);
                                setState(() {
                                  isLoading = false;
                                });
                              }
