...
child: Column(
                              ...
                              children: [
                                ...
                                buildPaymentType(
                                  ...
                                  if(!isLoading){
                                    ...
                                    payStatck("${paystackBean.paystack_public_key}",'$paymentCurrency',(double.parse('${rechargeController.text}')*100).toInt());
                                  }
                            ...
                            child: buildPaymentType(
                              ...
                              if(!isLoading){
                                ...
                                Navigator.of(context).push(MaterialPageRoute(builder: (context){
                                  return PaypalPayment(clientId:'${payPalBean.paypal_client_id}',secret:'${payPalBean.paypal_secret}',amount: '${double.parse('${rechargeController.text}')}',apCurrency: paymentCurrency,onFinish:(id,status){
                                    print('$id $status');
                                    if(status=='success'){
                          ...
                          Visibility(
                            ...
                            child: buildPaymentType(
                              ...
                              if(!isLoading){
                                ...
                                payStatck("${paystackBean.paystack_public_key}",'$paymentCurrency',(int.parse('${rechargeController.text}')*100).toInt());
                              }
                              ...
                              if(!isLoading){
                                ...
                                Navigator.of(context).pushNamed(PageRoutes.stripecard).then((value){
                                  if(value!=null){
                                    ...
                                    setStripePayment(stripeBean.stripe_secret,double.parse('${rechargeController.text}'),cardPay,paymentCurrency,context);
                                  }else{
  ...
  void razorPay(keyRazorPay, amount, String secretKey) async {
    ...
    createOrderId(keyRazorPay,secretKey,amount.toInt(),paymentCurrency,'order_trn_${DateTime.now().millisecond}',_razorpay);
  }
