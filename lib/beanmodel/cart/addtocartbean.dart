...
class AddToCartMainModel{
  ...
  AddToCartMainModel(this.status, this.message, this.total_price, this.total_mrp, this.cart_items,this.delivery_charge);
  ...
  factory AddToCartMainModel.fromJson(dynamic json){
    ...
    return AddToCartMainModel(json['status'], json['message'], json['total_price'], json['total_mrp'], ct, json['delivery_charge']);
  }
