...
class CategoryDataModel {
  ...
  CategoryDataModel(
      this.title, this.cat_id, this.image, this.description, this.store_id, this.subcategory);
  ...
  factory CategoryDataModel.fromJson(dynamic json) {
    ...
    return CategoryDataModel(json['title'], json['cat_id'], '$imagebaseUrl${json['image']}',
        json['description'], json['store_id'], subchildRe);
  }

  @override
  String toString() {
    return '{title: $title, cat_id: $cat_id, image: $image, description: $description, store_id: $store_id, subcategory: $subcategory}';
  }
}
