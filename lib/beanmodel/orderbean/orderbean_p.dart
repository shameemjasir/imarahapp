...
class MyOrderBeanMain {
  ...
  @override
  String toString() {
    return 'MyOrderBeanMain{storeName: $storeName, storeOwner: $storeOwner, storePhone: $storePhone, storeEmail: $storeEmail, storeAddress: $storeAddress, orderStatus: $orderStatus, deliveryDate: $deliveryDate, timeSlot: $timeSlot, paymentMethod: $paymentMethod, paymentStatus: $paymentStatus, paidByWallet: $paidByWallet, cartId: $cartId, price: $price, delCharge: $delCharge, remainingAmount: $remainingAmount, couponDiscount: $couponDiscount, dboyName: $dboyName, dboyPhone: $dboyPhone, userName: $userName, userAddress: $userAddress, data: $data}';
  }
}
...
class MyOrderDataMain {
  ...
  @override
  String toString() {
    return 'MyOrderDataMain{storeOrderId: $storeOrderId, productName: $productName, varientImage: $varientImage, quantity: $quantity, unit: $unit, varientId: $varientId, qty: $qty, price: $price, totalMrp: $totalMrp, orderCartId: $orderCartId, orderDate: $orderDate, storeApproval: $storeApproval, storeId: $storeId, description: $description}';
  }
}